...
/*Host server Start */
// Users
function confirmation_dialogYNCancelHostServer(reqId,title,msg,w,popType,caption1,caption2){
	var objPop = $("#popup"), popTitle = $('#popTitle'), objOverLay = $("#popupOverlay"), objContnt = $("#popup_content");
	var popW= (w)? w : 500;
	objContnt.html('');
	popTitle.html(title);
	...
	if (popType == 'YesNo'){
		...
		objContnt.append('<div class="ynpopup_button buttonsAll8"><input type="button" value="'+yesCaption+'" id="'+reqId+'" class="btn-popup" onclick="submitPopCancelHostServer(this.id);"/><input type="button" class="btn-popup" value="'+noCaption+'" onclick="hidePopup(\'popup\',\'popupOverlay\')"/></div>');
	}
...
function submitPopCancelHostServer(btn){
	document.location.href="./remsDeleteHostServer?id="+btn;
}

//Admin
function confirmation_dialogYNCancelHostServerAd(reqId,title,msg,w,popType,caption1,caption2){
	var objPop = $("#popup"), popTitle = $('#popTitle'), objOverLay = $("#popupOverlay"), objContnt = $("#popup_content");
	var popW= (w)? w : 500;
	objContnt.html('');
	popTitle.html(title);
	...
	if (popType == 'YesNo'){
		...
		objContnt.append('<div class="ynpopup_button buttonsAll8"><input type="button" value="'+yesCaption+'" id="'+reqId+'" class="btn-popup" onclick="submitPopCancelHostServerAd(this.id);"/><input type="button" class="btn-popup" value="'+noCaption+'" onclick="hidePopup(\'popup\',\'popupOverlay\')"/></div>');
	}
...
function submitPopCancelHostServerAd(btn){
	document.location.href="./remsDeleteHostServerAd?id="+btn;
}
...
// Users
function confirmation_dialogYNCancelInstanceServer(reqId,title,msg,w,popType,caption1,caption2){
	var objPop = $("#popup"), popTitle = $('#popTitle'), objOverLay = $("#popupOverlay"), objContnt = $("#popup_content");
	var popW= (w)? w : 500;
	objContnt.html('');
	popTitle.html(title);
	...
	if (popType == 'YesNo'){
		...
		objContnt.append('<div class="ynpopup_button buttonsAll8"><input type="button" value="'+yesCaption+'" id="'+reqId+'" class="btn-popup" onclick="submitPopCancelInstanceServer(this.id);"/><input type="button" class="btn-popup" value="'+noCaption+'" onclick="hidePopup(\'popup\',\'popupOverlay\')"/></div>');
	}
...
function submitPopCancelInstanceServer(btn){
	document.location.href="./remsDeleteEnvInstance?id="+btn;
}

//Admin
function confirmation_dialogYNCancelInstanceServerAd(reqId,title,msg,w,popType,caption1,caption2){
	var objPop = $("#popup"), popTitle = $('#popTitle'), objOverLay = $("#popupOverlay"), objContnt = $("#popup_content");
	var popW= (w)? w : 500;
	objContnt.html('');
	popTitle.html(title);
	...
	if (popType == 'YesNo'){
		...
		objContnt.append('<div class="ynpopup_button buttonsAll8"><input type="button" value="'+yesCaption+'" id="'+reqId+'" class="btn-popup" onclick="submitPopCancelInstanceServerAd(this.id);"/><input type="button" class="btn-popup" value="'+noCaption+'" onclick="hidePopup(\'popup\',\'popupOverlay\')"/></div>');
	}
...
function submitPopCancelInstanceServerAd(btn){
	document.location.href="./remsDeleteEnvInstanceAd?id="+btn;
}
...
/*Booking Start */
 // Users
function confirmation_dialogYNCancelBooking(reqId,title,msg,w,popType,caption1,caption2){
	var objPop = $("#popup"), popTitle = $('#popTitle'), objOverLay = $("#popupOverlay"), objContnt = $("#popup_content");
	var popW= (w)? w : 500;
	objContnt.html('');
	popTitle.html(title);
	...
	if (popType == 'YesNo'){
		...
		objContnt.append('<div class="ynpopup_button buttonsAll8"><input type="button" value="'+yesCaption+'" id="'+reqId+'" class="btn-popup" onclick="submitPopCancelBooking(this.id);"/><input type="button" class="btn-popup" value="'+noCaption+'" onclick="hidePopup(\'popup\',\'popupOverlay\')"/></div>');
	}
...
function submitPopCancelBooking(btn){
	document.location.href="./remsDeleteEnvBooking?id="+btn;
}

//Admin
function confirmation_dialogYNCancelBookingAd(reqId,title,msg,w,popType,caption1,caption2){
	var objPop = $("#popup"), popTitle = $('#popTitle'), objOverLay = $("#popupOverlay"), objContnt = $("#popup_content");
	var popW= (w)? w : 500;
	objContnt.html('');
	popTitle.html(title);
	...
	if (popType == 'YesNo'){
		...
		objContnt.append('<div class="ynpopup_button buttonsAll8"><input type="button" value="'+yesCaption+'" id="'+reqId+'" class="btn-popup" onclick="submitPopCancelBookingAd(this.id);"/><input type="button" class="btn-popup" value="'+noCaption+'" onclick="hidePopup(\'popup\',\'popupOverlay\')"/></div>');
	}
...
function submitPopCancelBookingAd(btn){
	document.location.href="./remsDeleteEnvBookingAd?id="+btn;
}
