...
<title>REMS | Display Users</title>
								...
								<c:forEach items="${displayUser}" var="item">
									<tr>
										...
										<td><c:if
												...
												test="${item.tdmUserAuthDTO.role == 'ROLE_ENVOWNER' }">
                                                 Env Owner
                                         </c:if> <c:if
							...
							<tbody>
								<tr>
									<td colspan="4" align="center" valign="middle"
										class="buttonsAll22"><input type="submit" name="newUser"
										id="newUser" value="Create New User"></td>
								</tr>
							</tbody>
						</table>
