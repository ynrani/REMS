...
import com.rems.util.DownloadUtils;
...
public class LoginController
{
	...
	RemsAdminService tdmAdminService;
	 ...
	 * @return
	 */
	@RequestMapping(AppConstant.TDM_ENVI_AVA)
	public String envOwner() {
		logger.info(MessageConstant.TDM_ENV_LOGIN_CTLR + MessageConstant.TDM_LOGIN_ENV_OWNER
				+ MessageConstant.LOG_INFO_PARAMS_NO);
		return AppConstant.TDM_ENV_OWNER_VIEW;
	}
