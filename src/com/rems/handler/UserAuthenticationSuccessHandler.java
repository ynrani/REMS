...
public class UserAuthenticationSuccessHandler implements AuthenticationSuccessHandler
{
	...
	protected void handle(HttpServletRequest request, HttpServletResponse response, Authentication authentication)
		...
		request.getSession().setAttribute(AppConstant.SESSION_PROJ, request.getParameter(AppConstant.SESSION_PROJ));
	...
	protected String determineTargetUrl(Authentication authentication) {
		...
		for (GrantedAuthority grantedAuthority : authorities) {
			...
			if (role.equals(AppConstant.ROLE_USER)) {
				isEnvOwner = true;
				break;
			} else if (role.equals(AppConstant.ROLE_ENVOWNER)) {
				isUser = true;
				break;
		...
		if (isUser) {
			...
			logger.error(MessageConstant.TDM_AUTH_HANDLER + MessageConstant.TDM_AUTH_DETERMINE_TAR_URL
