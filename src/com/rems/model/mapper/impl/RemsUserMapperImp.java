/*---------------------------------------------------------------------------------------
 * Object Name: RemsUserMapperImp.Java
 * 
 * Modification Block:
 * --------------------------------------------------------------------------------------
...
public class RemsUserMapperImp implements RemsUserMapper
{
	private static Logger logger = Logger.getLogger(RemsUserMapperImp.class);
